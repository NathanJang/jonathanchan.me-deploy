(globalThis.webpackChunk_ember_auto_import_=globalThis.webpackChunk_ember_auto_import_||[]).push([[633],{7388(e,t,r){"use strict"
r.r(t)
...
const m=g
r.d(t,["default",0,m])},1678(e,t,r){"use strict"
r.r(t),r(1603),r(941)},2492(e,t,r){"use strict"
...
{const t=Number(e)
return a(t)?t:null}}static create(){return new this}}class c{deserialize(e,t){return e||""===e?String(e):null}serialize(e,t){return e||""===e?String(e):null}static create(){return new this}}},8738(e,t,r){"use strict"
...
return(0,n.updateTag)(s,e),(0,n.consumeTag)(e),a}}},willSyncFlushWatchers:()=>!!s._backburner.currentInstance&&!0!==s._backburner._autorun,waitFor:async e=>e}}},825(e,t,r){"use strict"
...
const $={}
E($,"reason",null),E($,"value",null),E($,"result",null),E($,"error",null),E($,"status","pending"),E($,"isPending",!0),E($,"isLoading",!0),E($,"isSuccess",!1),E($,"isError",!1),Symbol.for("LegacyPromiseProxy"),r.d(t,["A",0,a,"O",0,l,"S",0,p])},4467(e,t,r){"use strict"
r(1603)
var i=r(5546)
...
i?t+=l:r+=l}a===e.length-1&&(o[t]=!s.has(t)||n(r))}else i=!0,o[t]=!s.has(t)||n(r),t="",r=""}return o},200)},793(e,t,r){"use strict"
r.d(t,{a:()=>a,c:()=>k,d:()=>p,e:()=>w,f:()=>f,g:()=>g,s:()=>y,u:()=>R})
...
return{resolve:e,reject:t,promise:r}}function R(e,t){return e[i.J6]=!0,e.getStream=t.getStream,e.abort=t.abort,e.onFinalize=t.onFinalize,e.id=t.id,e.lid=t.lid,e.requester=t.requester,e}r.d(t,["I",0,m])},9471(e,t,r){"use strict"
r.d(t,{C:()=>Ge,F:()=>Zt,S:()=>je,a:()=>A,b:()=>w,d:()=>Ne,f:()=>ke,g:()=>xe,h:()=>L,i:()=>S,j:()=>B,k:()=>K,l:()=>Je,n:()=>R,r:()=>U,s:()=>H,z:()=>Qt})
...
function H(e,t){return K.get(e)??null}class W{constructor(e){this.store=e,this.__instances={record:new Map,document:new Map},this._storeWrapper=new I(this.store),e.cacheKeyManager.__configureMerge((e,t,r)=>{let i=e
...
return t||(t=G(this,e,{})),t}recordIsLoaded(e,t=!1){const r=this.cache
if(!r)return!1
...
null===n||null!==t?(this.store.cacheKeyManager.peekResourceKey({type:r,id:t}),null===e.id&&this.store.cacheKeyManager.updateRecordIdentifier(e,{type:r,id:t}),this.store.notifications.notify(e,"identity",null)):(0,s.warn)(`Your ${r} record was saved to the server, but the response does not have an id.`,!(null!==n&&null===t))}}function G(e,t,r){const i=e.store.instantiateRecord(t,r)
...
e.push(...t)}class Re{constructor(e){this.store=e.store,this.isDestroying=!1,this.isDestroyed=!1,this._live=new Map,this._managed=new Set,this._pending=new Map,this._staged=new Map,this._keyedArrays=new Map,this._identifiers=new Map,this._set=new Map,this._visibilitySet=new Map,this._documentSubscription=this.store.notifications.subscribe("document",(e,t)=>{if("updated"===t&&this._keyedArrays.has(e.lid)){const t=this._keyedArrays.get(e.lid)
...
s.push(t),r.add(t)}else r.has(t)&&(n.push(t),r.delete(t))}),n.length&&(n.length===i.length?i.length=0:n.forEach(e=>{const t=i.indexOf(e);-1!==t&&(i.splice(t,1),r.delete(e))})),s.length&&ke(i,s)}(e,t,this._set.get(e)),this._pending.delete(e)),r||function(e){const t=e[o.a]
...
let t=null
var r
return"requestKey"in e?(t=me({store:this.store,manager:this,source:e.source,options:{requestKey:e.requestKey}}),this._keyedArrays.set(e.requestKey.lid,t),this._set.set(t,new Set(e.source)),Se(this._identifiers,t,e.source)):"query"in e?(t=ye({store:(r={store:this.store,manager:this,source:[],type:e.type,query:e.query,isLoaded:!1,links:null,meta:null}).store,manager:r.manager,editable:!1,source:r.source,data:{links:r.links,meta:r.meta},features:{query:r.query,modelName:r.type,update:Q,_update:be,save:J,DEPRECATED_CLASS_NAME:"LegacyQueryArray",isUpdating:!1,isLoaded:r.isLoaded,_updatingPromise:null},extensions:null,options:null,destroy:ve,mutate:null}),this._set.set(t,new Set)):(t=me({store:this.store,manager:this,source:e.source,options:null}),this._set.set(t,new Set(e.source)),Se(this._identifiers,t,e.source)),this._managed.add(t),t}dirtyArray(e,t,r){if(e===we)return
...
s.length=0,ke(s,t),this._set.set(e,new Set(t)),Ee(e)&&((0,i.n)(e[o.a].signal),e.meta=r?.meta||null,e.links=r?.links||null,e.isLoaded=!0),function(e,t,r){for(let i=0;i<r.length;i++)Ae(e,t,r[i])}(this._identifiers,e,n),Se(this._identifiers,e,t)}identifierAdded(e){const t=this._getPendingFor(e,!1)
...
this._visibilitySet.clear()}destroy(){this.isDestroying=!0,this.clear(!1),this._live.clear(),this.store.notifications.unsubscribe(this._subscription),this.store.notifications.unsubscribe(this._documentSubscription),this.isDestroyed=!0}}function Se(e,t,r){for(let i=0;i<r.length;i++){const s=r[i]
let n=e.get(s)
n||(n=new Set,e.set(s,n)),n.add(t)}}function Ae(e,t,r){const i=e.get(r)
i&&i.delete(t)}function Ee(e){const t=e[o.a]
return null!==t.features&&"LegacyQueryArray"===t.features.DEPRECATED_CLASS_NAME}const Me=(0,l.L1)("Touching",Symbol("touching")),Ce=(0,l.L1)("RequestPromise",Symbol("promise")),Te=[]
...
return n[Me]=[r.recordIdentifier],n[Ce]=e,this._pending.get(i).push(n),this._triggerSubscriptions(n),e.then(e=>{this._dequeue(i,n)
const r={state:"fulfilled",request:t,type:s,response:{data:e}}
return r[Me]=n[Me],this._addDone(r),this._triggerSubscriptions(r),e},e=>{this._dequeue(i,n)
const r={state:"rejected",request:t,type:s,response:{data:e}}
throw r[Me]=n[Me],this._addDone(r),this._triggerSubscriptions(r),e})}}_triggerSubscriptions(e){"pending"!==e.state?(this._toFlush.push(e),1===this._toFlush.length&&this._store.notifications._onNextFlush(()=>{this._flush()})):this._flushRequest(e)}_flush(){this._toFlush.forEach(e=>{this._flushRequest(e)}),this._toFlush=[]}_flushRequest(e){e[Me].forEach(t=>{const r=this._subscriptions.get(t)
...
n&&("hasMany"===n.kind?r[i]=Fe(r[i]):"belongsTo"===n.kind&&(r[i]=Ie(r[i])))}}}return r}(this,l,n),d=c.clientDidCreate(l,u)
i=function(e,t,r){let i=e.__instances.record.get(t)
if(!i&&(i=G(e,t,r),i instanceof Nt&&e.store.schema.resource)&&!e.store.schema.resource(t).legacy){const e=xt(i)
...
s&&e.call(t,i,s)}})}}je.prototype.findRecord=function(e,t,r){(0,s.deprecate)("store.findRecord is deprecated. Use store.request instead.",!1,{id:"warp-drive:deprecate-legacy-request-methods",until:"6.0",for:"@warp-drive/core",url:"https://docs.warp-drive.io/api/@warp-drive/core/build-config/deprecations/variables/ENABLE_LEGACY_REQUEST_METHODS",since:{enabled:"5.7",available:"5.7"}}),Pe(e)?r=t:e=Qe(R(e),k(t))
...
return"hasMany"===e.kind?{data:t.map(e=>Le(e,r))}:{data:t?Le(t,r):null}}(n,t))})
const n=e.cache,o=Boolean(e._instanceCache.peek(t))
n.upsert(t,i,o)}(this,i,r.preload)})),this.request({op:"findRecord",data:{record:i,options:r},cacheOptions:{[n.ER]:!0}}).then(e=>e.content)},je.prototype.findAll=function(e,t={}){return(0,s.deprecate)("store.findAll is deprecated. Use store.request instead.",!1,{id:"warp-drive:deprecate-legacy-request-methods",until:"6.0",for:"@warp-drive/core",url:"https://docs.warp-drive.io/api/@warp-drive/core/build-config/deprecations/variables/ENABLE_LEGACY_REQUEST_METHODS",since:{enabled:"5.7",available:"5.7"}}),this.request({op:"findAll",data:{type:R(e),options:t||{}},cacheOptions:{[n.ER]:!0}}).then(e=>e.content)},je.prototype.query=function(e,t,r={}){return(0,s.deprecate)("store.query is deprecated. Use store.request instead.",!1,{id:"warp-drive:deprecate-legacy-request-methods",until:"6.0",for:"@warp-drive/core",url:"https://docs.warp-drive.io/api/@warp-drive/core/build-config/deprecations/variables/ENABLE_LEGACY_REQUEST_METHODS",since:{enabled:"5.7",available:"5.7"}}),this.request({op:"query",data:{type:R(e),query:t,options:r},cacheOptions:{[n.ER]:!0}}).then(e=>e.content)},je.prototype.queryRecord=function(e,t,r){return(0,s.deprecate)("store.queryRecord is deprecated. Use store.request instead.",!1,{id:"warp-drive:deprecate-legacy-request-methods",until:"6.0",for:"@warp-drive/core",url:"https://docs.warp-drive.io/api/@warp-drive/core/build-config/deprecations/variables/ENABLE_LEGACY_REQUEST_METHODS",since:{enabled:"5.7",available:"5.7"}}),this.request({op:"queryRecord",data:{type:R(e),query:t,options:r||{}},cacheOptions:{[n.ER]:!0}}).then(e=>e.content)},je.prototype.getReference=function(e,t){let r;(0,s.deprecate)("store.getReference is deprecated. There is no direct replacement. For working with the cache and relationships, use the cache with the appropriate identifiers. To load, use store.request.",!1,{id:"warp-drive:deprecate-legacy-request-methods",until:"6.0",for:"@warp-drive/core",url:"https://docs.warp-drive.io/api/@warp-drive/core/build-config/deprecations/variables/ENABLE_LEGACY_REQUEST_METHODS",since:{enabled:"5.7",available:"5.7"}}),r=1===arguments.length&&Pe(e)?e:Qe(R(e),k(t))
...
let o=n.get(i)
return o||(o=new ze(this,i),n.set(i,o)),o},je.prototype.modelFor=function(e){return(0,s.deprecate)(`store.modelFor is deprecated, please use store.schema.fields({ type: '${e}' }) to access schema information instead.`,!1,{id:"warp-drive:deprecate-legacy-request-methods",until:"6.0",for:"@warp-drive/core",url:"https://docs.warp-drive.io/api/@warp-drive/core/build-config/deprecations/variables/ENABLE_LEGACY_REQUEST_METHODS",since:{enabled:"5.7",available:"5.7"}}),function(e,t){let r=$e.get(e)
r||(r=Object.create(null),$e.set(e,r))
let i=r[t]
return void 0===i&&(i=r[t]=new Ue(e,t)),i}(this,e)},je.prototype.saveRecord=function(e,t={}){(0,s.deprecate)("store.saveRecord is deprecated, please use store.request to initiate a save request instead.",!1,{id:"warp-drive:deprecate-legacy-request-methods",until:"6.0",for:"@warp-drive/core",url:"https://docs.warp-drive.io/api/@warp-drive/core/build-config/deprecations/variables/ENABLE_LEGACY_REQUEST_METHODS",since:{enabled:"5.7",available:"5.7"}})
...
function Ke(e){return Boolean(e.op&&Be.has(e.op))}function He(e){const t=function(e){return e instanceof AggregateError||"AggregateError"===e.name&&Array.isArray(e.errors)}(e),r=t?new AggregateError(structuredClone(e.errors),e.message):new Error(e.message)
return r.stack=e.stack,r.error=e.error,Object.assign(r,e),r}function We(e,t,r){if(e){const r=t.get(e)
if(r)return r.priority}return r}const Ge={request(e,t){if(!e.request.store||e.request.cacheOptions?.[n.ER])return t(e.request)
...
return t.op&&Be.has(t.op)||s?.reload||!r||!(!e.lifetimes||!i)&&e.lifetimes.isHardExpired(i,e)}(r,e.request,!!a,i)){if(o)return o.priority={blocking:!0},o.promise
let n=Ve(t,e,i,{blocking:!0})
...
return s?.backgroundReload||!(!e.lifetimes||!i)&&e.lifetimes.isSoftExpired(i,e)}(r,e.request,0,i)){let n=o?.promise||Ve(t,e,i,{blocking:!1})
...
if(e.setResponse(a.response),"error"in a){const t=l?Ye(r,e.request,{shouldHydrate:l,identifier:i},a.content):a.content,s=He(a)
throw s.content=t,s}return l?Ye(r,e.request,{shouldHydrate:l,identifier:i},a.content):a.content}}
function Ye(e,t,r,i){const{identifier:s}=r
return i&&r.shouldHydrate?s?e._instanceCache.getDocument(s):g(e,null,{request:t,document:i}):i??null}function Ve(e,t,r,i){const{store:s}=t.request,o={shouldHydrate:t.request[n._q]||!1,identifier:r,priority:i}
let a=!1
Ke(t.request)&&(a=!0,Array.isArray(t.request.records)?t.request.records.forEach(e=>{s.cache.willCommit(e,t)}):t.request.data?.record&&s.cache.willCommit(t.request.data.record,t)),s.lifetimes?.willRequest&&s.lifetimes.willRequest(t.request,r,s)
...
return Ke(t)?Array.isArray(t.records)?s=e.cache.didCommit(t.records,i):t.data?.record?s=e.cache.didCommit(t.data.record,i):function(e){return!Ke(e.request)||("createRecord"===e.request.op&&201===e.response?.status?!!e.content&&Object.keys(e.content).length>0:204!==e.response?.status)}(i)&&(s=e.cache.put(i)):s=e.cache.put(i),Ye(e,t,r,s)}(e,s,r,i)}),e._enableAsyncFlush=null,e.lifetimes?.didRequest&&e.lifetimes.didRequest(t.request,i.response,r.identifier,e),We(r.identifier,e.requestManager._deduped,r.priority).blocking)return n
...
if(!Ke(t.request))return s=e.cache.put(i),Ye(e,t.request,r,s)
{const r=i&&i.content&&"object"==typeof i.content&&"errors"in i.content&&Array.isArray(i.content.errors)?i.content.errors:void 0
Array.isArray(t.request.records)?e.cache.commitWasRejected(t.request.records,r):t.request.data?.record?e.cache.commitWasRejected(t.request.data.record,r):e.cache.put(i)}}(e,t,r,i)}),e._enableAsyncFlush=null,r.identifier&&e.lifetimes?.didRequest&&e.lifetimes.didRequest(t.request,i.response,r.identifier,e),Ke(t.request))throw i
if(We(r.identifier,e.requestManager._deduped,r.priority).blocking){const e=He(i)
throw e.content=s,e}e.notifications._flush()}(s,t,o,e))
if(!a)return l
const c=t.request.data?.record||t.request.records?.[0]
return s._requestCache._enqueue(l,{data:[{op:"saveRecord",recordIdentifier:c,options:void 0}]})}function Ze(e){return Boolean(e&&"string"==typeof e)}function Qe(e,t,r){if("object"==typeof e&&null!==e){const t=e
return S(t)||"id"in t&&(t.id=w(t.id)),t}{const i=w(t)
if(!Ze(i)){if(Ze(r))return{lid:r}
throw new Error("Expected either id or lid to be a valid string")}return Ze(r)?{type:e,id:i,lid:r}:{type:e,id:i}}}function Je(e){const t=e.store.schema.CAUTION_MEGA_DANGER_ZONE_arrayExtensions?e.store.schema.CAUTION_MEGA_DANGER_ZONE_arrayExtensions(e.field):null
return ye({store:e.store,manager:e.manager,editable:e.editable,source:e.source,data:{links:e.links,meta:e.meta},features:{modelName:e.type,save:J,DEPRECATED_CLASS_NAME:"ManyArray",isLoaded:e.isLoaded,isAsync:e.isAsync,isPolymorphic:e.isPolymorphic,identifier:e.identifier,key:e.field.name,reload:tt,createRecord:rt,notify:et},extensions:t,options:null,destroy:it,mutate:Xe})}function Xe(e,t,r,i,s){const n=t
switch(r){case"length 0":return Reflect.set(e,"length",0),ct(n,[],s),!0
case"replace cell":{const[t,r,a]=i
return e[t]=a,function(e,t,r){ut(e,{op:"replaceRelatedRecord",record:e[o.a].features.identifier,field:e.key,...t},r)}(n,{value:a,prior:r,index:t},s),!0}case"push":{const o=st(i)
ot(n,e,e=>e.push(...o),"Cannot push duplicates to a hasMany's state.")
{const o=new Set(e),a=new Set
i.forEach(e=>{const t=U(e)
o.has(t)||(o.add(t),a.add(e))})
const l=Array.from(a),c=Reflect.apply(e[r],t,l)
return l.length&&at(n,{value:st(l)},s),c}}case"pop":{const o=Reflect.apply(e[r],t,i)
return o&&lt(n,{value:U(o)},s),o}case"unshift":{const o=st(i)
ot(n,e,e=>e.unshift(...o),"Cannot unshift duplicates to a hasMany's state.")
{const o=new Set(e),a=new Set
i.forEach(e=>{const t=U(e)
o.has(t)||(o.add(t),a.add(e))})
const l=Array.from(a),c=Reflect.apply(e[r],t,l)
return l.length&&at(n,{value:st(l),index:0},s),c}}case"shift":{const o=Reflect.apply(e[r],t,i)
return o&&lt(n,{value:U(o),index:0},s),o}case"sort":{const a=Reflect.apply(e[r],t,i)
return function(e,t,r){ut(e,{op:"sortRelatedRecords",record:e[o.a].features.identifier,field:e.key,value:t},r)}(n,a.map(U),s),a}case"splice":{const[a,l,...c]=i
if(0===a&&l===n[o.a].source.length){const i=st(c)
ot(n,e,e=>e.splice(a,l,...i),"Cannot replace a hasMany's state with a new state that contains duplicates.")
{const i=new Set(c),o=Array.from(i),u=[a,l].concat(o),d=Reflect.apply(e[r],t,u)
return ct(n,st(o),s),d}}const u=st(c)
ot(n,e,e=>e.splice(a,l,...u),"Cannot splice a hasMany's state with a new state that contains duplicates.")
{const i=e.slice()
i.splice(a,l)
const o=new Set(i),u=[]
...
if(d.isStale&&(null!==_||ht.has(r)||ft(r))){d.isStale=!1
...
y.push(_)
const m={store:e.store,resourceKey:e.resourceKey,modeName:e.modeName,legacy:e.legacy,editable:e.editable,path:y,field:c,value:n},b=new Nt(m)
return g.set(l,{type:n,identity:l,index:_,context:m,value:new WeakRef(b)}),b}if(ft(r)){let s=h.get(r)
...
return f=!1,e},h.set(r,s)),s}if(function(e){return pt.has(e)}(r)){let e=h.get(r)
...
return d=(0,i.e)(u,_,i.A,void 0),_}}function gt(e){const t=(0,i.e)(e.signals,e.record,e.path.at(-1),null),{record:r}=e
let s=t.value
...
s=new yt(e,r,c),t.value=s}return s}Object.defineProperty(yt.prototype,"[]",{enumerable:!0,configurable:!1,get:function(){return this}})
const mt=["alias","derived","@local"]
function _t(e){return t=e.kind,!mt.includes(t)&&"@id"!==e.kind&&"@hash"!==e.kind
var t}function bt(e){return e.sourceKey||e.name}function vt(e){return"sourceKey"in e&&e.sourceKey?e.sourceKey:e.name}class wt{constructor(e,t){const r=e[o.a]
...
i!==r.data&&(i.length=0,ke(i,r.data))}reloadHasMany(e,t){const r=this.store.schema.fields(this.identifier).get(e),i=t?function(e){const t={}
return"reload"in e&&(t.reload=e.reload),"backgroundReload"in e&&(t.backgroundReload=e.backgroundReload),t}(t):{reload:!0}
i.types=[r.type]
const s=this.store.cache.getRelationship(this.identifier,e),o={url:kt(s),op:"findHasMany",method:"GET",records:s.data,cacheOptions:i,options:{field:r,identifier:this.identifier,links:s.links,meta:s.meta},[n._q]:!1}
return this.store.request(o)}mutate(e){this.store.cache.mutate(e)}}function kt(e){const t=e.links?.related
return"object"==typeof t?t.href:t}const Rt=new Set([i.O,o.a,o.S])
class St{constructor(e){const{field:t,path:r}=e,s=this
...
return new Proxy(this[o.S],{ownKeys:()=>Object.keys(s[o.S]),has:(e,t)=>t in s[o.S],getOwnPropertyDescriptor:(t,r)=>({writable:e.editable,enumerable:!0,configurable:!0}),get(h,f,p){if(Rt.has(f))return s[f]
...
function Et(e,t){const r=At.get(e)
if(r)return r.get(t.name)}class Mt{constructor(e){const{store:t,resourceKey:r}=e,{cache:i}=t,s=bt(e.field),n=e.editable?i.getRelationship(r,s):i.getRemoteRelationship(r,s)
this.lid=n.lid??n.links?.self??`relationship:${r.lid}.${s}`,this.data=n.data?t.peekRecord(n.data):null,this.name=s,this.links=n.links??{},this.meta=n.meta??{},this[o.a]=e}fetch(e){const t=e?.url??Ct(this.links.related)??Ct(this.links.self)??null
...
return this[o.a].store.request(r)}}function Ct(e){return e?"string"==typeof e?e:e.href:null}(0,i.b)(Mt.prototype,"data",null),(0,i.b)(Mt.prototype,"links",null),(0,i.b)(Mt.prototype,"meta",null)
const Tt={"@hash":{get:function(e){const{field:t,path:r,resourceKey:i}=e,{schema:s,cache:n}=e.store,o=r.slice(0,-1),a=e.editable?n.getAttr(i,o):n.getRemoteAttr(i,o)
...
return r.value!==t&&(r.value=t,(0,i.n)(r)),!0},mutable:!0,enumerable:!1,serializable:!1},alias:{get:function(e){},set:function(e){return!1},mutable:!0,enumerable:!0,serializable:!1},array:{get:gt,set:function(e){const{field:t,record:r,value:s}=e,{cache:n,schema:o}=e.store,a=(0,i.p)(e.signals,e.path.at(-1)),l=a?.value,c=t.type?o.transformation(t):null,u=null===s?null:t.type?s.map(e=>c.serialize(e,t.options??null,r)):s?.slice()
...
if(t.options.linksMode){const i=e.editable?o.getRelationship(r,bt(t)):o.getRemoteRelationship(r,bt(t))
...
if(n)return n
const{editable:o,resourceKey:a}=e,{cache:l}=r,c=l.getRelationship(a,bt(s))
if(!c)return null
const u=Je({store:r,manager:new wt(i,o),source:c.data?.slice()??[],type:s.type,isLoaded:!0,editable:o,isAsync:s.options.async??!1,isPolymorphic:s.options.polymorphic??!1,field:s,identifier:a,links:c.links||null,meta:c.meta||null})
...
const{record:t,field:r}=e,s=At.get(t)
let n
...
if(!u)return null
r.type&&(u=c.transformation(r).hydrate(u,r.options??null,t)),n=new St({store:i,resourceKey:o,modeName:e.modeName,legacy:e.legacy,editable:e.editable,path:a,field:r,record:t,signals:e.signals,value:u}),s?s.set(r.name,n):At.set(t,new Map([[r.name,n]]))}return n},set:function(e){const{field:t,value:r,record:s}=e,{cache:n,schema:o}=e.store
if(!t.type){let o=r
null!==r?o={...r}:At.delete(s),n.setAttr(e.resourceKey,e.path,o)
const a=Et(s,t)
return a&&(a[i.O].isStale=!0),!0}const a=o.transformation(t).serialize({...r},t.options??null,s)
n.setAttr(e.resourceKey,e.path,a)
const l=Et(s,t)
return l&&(l[i.O].isStale=!0),!0},mutable:!0,enumerable:!0,serializable:!0},resource:{get:function(e){return(0,i.e)(e.signals,e.record,e.path.at(-1),null),new Mt(e)},set:function(e){return!1},mutable:!0,enumerable:!0,serializable:!0},"schema-array":{get:gt,set:function(e){const t=null===e.value?null:e.value?.slice(),r=(0,i.p)(e.signals,e.path.at(-1)),s=r?.value
...
Promise.resolve().then(()=>{p.value[o.D]()})}const y=new Nt({store:e.store,resourceKey:e.resourceKey,modeName:e.modeName,legacy:e.legacy,editable:e.editable,path:e.path,field:e.field,value:d})
...
for(const e of Object.keys(i))if(!s.has(e))return!1}else At.delete(e.record)
return t.cache.setAttr(e.resourceKey,e.path,i),!0},mutable:!0,enumerable:!0,serializable:!0}},qt=new Set(["length","nodeType","then","setInterval","document",n.k0]),Ot=[o.a,o.D,h.pm,o.C,o.b],Dt=new Set(Ot),jt=new Map
class Nt{constructor(e){const t=e.resourceKey,r=null!==e.path,s=e.store.schema,n=r?e.value:t.type,a=s.resource(r?{type:n}:t).identity,l=new Map,c=e.legacy?r?s.CAUTION_MEGA_DANGER_ZONE_objectExtensions(e.field,n):s.CAUTION_MEGA_DANGER_ZONE_resourceExtensions(t):null
...
if(t){const e=t[i.A];(0,i.n)(e)}}if("object"===t?.kind){const e=Et(y,t)
...
default:return{writable:!1,enumerable:!1,configurable:!1}}},get(r,s,n){if(Dt.has(s))return s===o.D?()=>Pt(n):s===o.C?()=>Promise.resolve(xt(n)):s===o.b?()=>Promise.resolve(async function(e){await Promise.resolve()
const t=e[o.a]
...
return e||(e=function*(){for(const e in n)yield[e,n[e]]},l.set(Symbol.iterator,e)),e}return"constructor"===s?Nt:ie(c,s)?se(n,c,p,s):void 0}const h="alias"===d.kind?d.options:d,f=e.path?.slice()??[],y=vt(h)
switch(f.push(y),h.kind){case"@id":case"@hash":case"@local":case"derived":case"field":case"attribute":case"schema-array":case"array":case"schema-object":case"object":case"resource":case"belongsTo":case"hasMany":case"collection":return Tt[h.kind].get({store:e.store,resourceKey:t,modeName:e.modeName,legacy:e.legacy,editable:e.editable,path:f,field:h,record:n,signals:p,value:null})}},set(r,i,s,n){if("___notifications"===i)return r[i]=s,!0
if(!e.editable)return!1
const o=i===a?.name?a:u.get(i)
if(!o)return null!==e.path?e.value:t.type,!!ie(c,i)&&ne(n,c,p,i,s)
const l="alias"===o.kind?o.options:o,d=e.path?.slice()??[],h=vt(l)
switch(d.push(h),l.kind){case"@id":case"@hash":case"@local":case"field":case"attribute":case"derived":case"array":case"schema-array":case"schema-object":case"object":case"resource":case"belongsTo":case"hasMany":case"collection":return Tt[l.kind].set({store:e.store,resourceKey:t,modeName:e.modeName,legacy:e.legacy,editable:e.editable,path:d,field:l,record:n,signals:p,value:s})
default:return!1}}})
return y}}function xt(e){const t=e[o.a]
...
const i=new Nt({store:t.store,resourceKey:t.resourceKey,modeName:t.legacy?"legacy":"polaris",legacy:t.legacy,editable:!0,path:null,field:null,value:null})
return B(i,U(e)),jt.set(e,i),i}function Pt(e){if(e[o.a].legacy)e.isDestroying=!0,e.isDestroyed=!0
else if(!e[o.a].editable){const t=jt.get(e)
t&&(Pt(t),function(e){z.delete(e)}(t))}e[o.a].store.notifications.unsubscribe(e.___notifications),e.___notifications=null}const Ft=(0,l.L1)("Support",new WeakMap);(function(e){let t=Ft.get(e)
return t||(t={},Ft.set(e,t)),t._constructor=t._constructor||{name:`ReactiveResource<${U(e).type}>`,get modelName(){}}})[h.ZU]="@constructor"
const It=["constructor","__proto__"]
function Lt(e,t,r){const i=e[t].get(r)
return i?.features??null}function zt(e){return"kind"in e&&("schema-array"===e.kind||"schema-object"===e.kind)}function $t(e,t,r,i){if("resource"===r&&!("objectExtensions"in t)&&t.objectExtensions?.length)return null
...
if(!a)return"array"===r?null:zt(t)?e.CAUTION_MEGA_DANGER_ZONE_resourceExtensions(i?{type:i}:t):null
const l="resource"===r&&zt(t)?e.CAUTION_MEGA_DANGER_ZONE_resourceExtensions(t):"object"===r&&zt(t)?e.CAUTION_MEGA_DANGER_ZONE_resourceExtensions(i?{type:i}:t):null
if(!l&&1===a.length){const e=Lt(n,s,a[0])
return o[s].set(t,e),e}const c=new Map(l)
for(const d of a){const e=Lt(n,s,d)
...
0===s.size&&(n.cacheFields=Kt(n)),this._schemas.set(e.type,n)}registerTrait(e){const t=Object.assign({},e,{fields:new Map})
...
for(const n of Object.getOwnPropertyNames(s)){if(It.includes(n))continue
...
continue}}return{kind:t,name:r,features:i}}(e))}CAUTION_MEGA_DANGER_ZONE_resourceExtensions(e){return $t(this,this.resource(e),"resource",null)}CAUTION_MEGA_DANGER_ZONE_objectExtensions(e,t){return $t(this,e,"object",t)}CAUTION_MEGA_DANGER_ZONE_arrayExtensions(e){return $t(this,e,"array",null)}CAUTION_MEGA_DANGER_ZONE_hasExtension(e){return this._extensions[e.kind].has(e.name)}_registerMode(e,t){this._modes.set(e,t)}_kind(e,t){return this._modes.get(e)[t]}registerHashFn(e){this._hashFns.set(e[h.ZU],e)}fields({type:e}){const t=this._schemas.get(e)
return t.finalized||Bt(this,t),t.fields}cacheFields({type:e}){const t=this._schemas.get(e)
return t.finalized||Bt(this,t),t.cacheFields}hasResource(e){return this._schemas.has(e.type)}}function Bt(e,t){const r=new Map,i=new Set
for(const s of t.traits){const n=e._traits.get(s)
Ht(e,n,r,i,t.original.type)}Wt(r,t.fields),t.fields=r,t.cacheFields=Kt(t),t.finalized=!0}function Kt(e){const{fields:t}=e,r=new Map
for(const[i,s]of t)if(_t(s)){const e=bt(s)
r.set(e,s)}return r}function Ht(e,t,r,i,n,o){if(!i.has(t)){if(i.add(t),t.traits?.length)for(const o of t.traits){const a=e._traits.get(o);(0,s.warn)(`The trait ${o} used by the trait ${t.name} MUST be supplied before the resource ${n} can be finalized for use.`,!!a,{id:"warp-drive:missing-trait-schema-for-resource"}),a&&Ht(e,a,r,i,n)}Wt(r,t.fields)}}function Wt(e,t){for(const[r,i]of t)e.set(r,i)}Ut.prototype.attributesDefinitionFor=function({type:e}){(0,s.deprecate)("Use `schema.fields({ type })` instead of `schema.attributesDefinitionFor({ type })`",!1,{id:"ember-data:schema-service-updates",until:"6.0",for:"ember-data",since:{available:"4.13",enabled:"5.4"}})
const t=this._schemas.get(e)
if(!t)throw new Error(`No schema defined for ${e}`)
return t.attributes},Ut.prototype.relationshipsDefinitionFor=function({type:e}){(0,s.deprecate)("Use `schema.fields({ type })` instead of `schema.relationshipsDefinitionFor({ type })`",!1,{id:"ember-data:schema-service-updates",until:"6.0",for:"ember-data",since:{available:"4.13",enabled:"5.4"}})
const t=this._schemas.get(e)
if(!t)throw new Error(`No schema defined for ${e}`)
return t.relationships},Ut.prototype.doesTypeExist=function(e){return(0,s.deprecate)("Use `schema.hasResource({ type })` instead of `schema.doesTypeExist(type)`",!1,{id:"ember-data:schema-service-updates",until:"6.0",for:"ember-data",since:{available:"4.13",enabled:"5.4"}}),this._schemas.has(e)}
const Gt="undefined"!=typeof fetch?(...e)=>fetch(...e):"undefined"!=typeof FastBoot?(...e)=>FastBoot.require("node-fetch")(...e):()=>{throw new Error("No Fetch Implementation Found")},Yt=new Set(["updateRecord","createRecord","deleteRecord"]),Vt=new Map([[400,"Bad Request"],[401,"Unauthorized"],[402,"Payment Required"],[403,"Forbidden"],[404,"Not Found"],[405,"Method Not Allowed"],[406,"Not Acceptable"],[407,"Proxy Authentication Required"],[408,"Request Timeout"],[409,"Conflict"],[410,"Gone"],[411,"Length Required"],[412,"Precondition Failed"],[413,"Payload Too Large"],[414,"URI Too Long"],[415,"Unsupported Media Type"],[416,"Range Not Satisfiable"],[417,"Expectation Failed"],[419,"Page Expired"],[420,"Enhance Your Calm"],[421,"Misdirected Request"],[422,"Unprocessable Entity"],[423,"Locked"],[424,"Failed Dependency"],[425,"Too Early"],[426,"Upgrade Required"],[428,"Precondition Required"],[429,"Too Many Requests"],[430,"Request Header Fields Too Large"],[431,"Request Header Fields Too Large"],[450,"Blocked By Windows Parental Controls"],[451,"Unavailable For Legal Reasons"],[500,"Internal Server Error"],[501,"Not Implemented"],[502,"Bad Gateway"],[503,"Service Unavailable"],[504,"Gateway Timeout"],[505,"HTTP Version Not Supported"],[506,"Variant Also Negotiates"],[507,"Insufficient Storage"],[508,"Loop Detected"],[509,"Bandwidth Limit Exceeded"],[510,"Not Extended"],[511,"Network Authentication Required"]]),Zt={async request(e){let t
try{t=await Gt(e.request.url,e.request)}catch(e){throw e instanceof DOMException&&"AbortError"===e.name?(e.statusText="Aborted",e.status=20,e.isRequestError=!0):(e.statusText="Unknown Network Error",e.status=0,e instanceof DOMException||(e.code=0),e.isRequestError=!0),e}const r=!t.ok||t.status>=400,i=e.request.op,s=Boolean(i&&Yt.has(i))
...
try{r=JSON.parse(n)}catch{}const i=Array.isArray(r)?r:null!==(o=r)&&"object"==typeof o&&Array.isArray(r.errors)?r.errors:null,s=t.statusText||Vt.get(t.status)||"Unknown Request Error",a=`[${t.status} ${s}] ${e.request.method??"GET"} (${t.type}) - ${t.url}`,l=i?new AggregateError(i,a):new Error(a)
...
var o}}
class Qt{constructor(e){Object.assign(this,e),this._pending=new Map,this._deduped=new Map,this._handlers=[]}useCache(e){return e[a.I]=!0,this._handlers.unshift(e),this}use(e){return this._handlers.push(...e),this}request(e){const t=this._handlers,r=e.controller||new AbortController
...
return c&&(0,a.s)(u,c),u}static create(e){return new this(e)}}},9441(e,t,r){"use strict"
r.d(t,{Fp:()=>i.F,Je:()=>i.z,fV:()=>i.s,il:()=>i.S,lL:()=>i.C,o:()=>i.r})
var i=r(9471)
r(9369),r(6316),r(4467),r(1603),r(5546),r(191)},5348(e,t,r){"use strict"
r.d(t,{ud:()=>i.c})
var i=r(793)
r.d(t,["sw",0,function(e){return e}])},1505(e,t,r){"use strict"
r.d(t,{FA:()=>i.a,RX:()=>i.f,Rh:()=>i.d,TP:()=>i.j,WX:()=>i.l,Yj:()=>i.h,di:()=>i.n,fV:()=>i.s,i:()=>i.k,o:()=>i.r,pG:()=>i.b,v7:()=>i.g,wT:()=>i.i})
var i=r(9471)},9369(e,t,r){"use strict"
var i=r(1113)
const s=(0,i.L1)("SOURCE",Symbol("#source")),n=(0,i.L1)("Destroy",Symbol.dispose||Symbol.for("Dispose")),o=(0,i.L1)("Checkout",Symbol("Checkout")),a=(0,i.L1)("Commit",Symbol("Commit")),l=(0,i.L1)("Context",Symbol("Context"))
r.d(t,["C",0,o,"D",0,n,"S",0,s,"a",0,l,"b",0,a])},1113(e,t,r){"use strict"
...
function l(e,t){return t}function c(e){return a[`(transient) ${e}`]??null}function u(e,t){return a[`(transient) ${e}`]=t}function d(e,t){return t}function h(e){return n[`(transient) ${e}`]??null}function f(e,t){return n[`(transient) ${e}`]=t}o.__warpDrive_hasOtherCopy=!0},8382(e,t,r){"use strict"
var i=r(1113)
const s=(0,i.vs)("SkipCache",Symbol.for("wd:skip-cache")),n=(0,i.vs)("EnableHydration",Symbol.for("wd:enable-hydration")),o=(0,i.L1)("IS_FUTURE",Symbol("IS_FUTURE")),a=(0,i.L1)("DOC",Symbol("DOC"))
r.d(t,["ER",0,s,"J6",0,o,"_q",0,n,"k0",0,a])},191(e,t,r){"use strict"
...
n&&Object.assign(i,JSON.parse(n))},9370(e,t,r){"use strict"
var i=r(1113)
const s=(0,i.L1)("Store",Symbol("Store")),n=(0,i.L1)("$type",Symbol("$type"));(0,i.L1)("RequestSignature",Symbol("RequestSignature")),r.d(t,["ZU",0,n,"pm",0,s])},5546(e,t,r){"use strict"
r.d(t,{_k:()=>a,qK:()=>i})
...
function a(e){return o.get(e)}},941(e,t){"use strict"
...
return e}C(o.irregularPairs),t.camelize=function(e){return c.get(e)},t.capitalize=y,t.clear=function(){v.clear(),w.clear()},t.clearRules=T,t.dasherize=function(e){return n.get(e)},t.irregular=function(e,t){R.set(e.toLowerCase(),t),R.set(t.toLowerCase(),t),S.set(t.toLowerCase(),e),S.set(e.toLowerCase(),e)},t.loadIrregular=C,t.loadUncountable=function(e){e.forEach(e=>{M(e)})},t.plural=function(e,t){E.has(e)&&E.delete(e),q([e,t],E)},t.pluralize=function(e){return e?w.get(e):""},t.resetToDefaults=function(){T(),o.uncountable.forEach(e=>k.add(e)),o.singular.forEach(e=>A.set(e[0],e[1])),o.plurals.forEach(e=>E.set(e[0],e[1])),C(o.irregularPairs)},t.setMaxLRUCacheSize=function(e){c.size=e,h.size=e,p.size=e,n.size=e},t.singular=function(e,t){A.has(e)&&A.delete(e),q([e,t],A)},t.singularize=function(e){return e?v.get(e):""},t.uncountable=M,t.underscore=function(e){return h.get(e)}},9485(e,t,r){"use strict"
r.r(t),r.d(t,{default:()=>s,deprecationCollector:()=>c,detectWorkflow:()=>o,flushDeprecations:()=>a,handleDeprecationWorkflow:()=>l})
var i=r(1603)
function s(e){self.deprecationWorkflow=self.deprecationWorkflow||{},self.deprecationWorkflow.deprecationLog={messages:new Set},(0,i.registerDeprecationHandler)((t,r,i)=>l(e,t,r,i)),(0,i.registerDeprecationHandler)(c),self.deprecationWorkflow.flushDeprecations=t=>a({config:e,...t})}function n(e,t){return"string"==typeof e&&e===t||e instanceof RegExp&&e.exec(t)}function o(e,t,r){if(!e||!e.workflow)return
let i,s,o,a
for(i=0;i<e.workflow.length;i++)if(s=e.workflow[i],o=s.matchMessage,a=s.matchId,n(a,r?.id)||n(o,t))return s}function a({handler:e="silence",config:t={}}={}){let r=self.deprecationWorkflow.deprecationLog.messages,i=t.workflow??[],s=r.values().filter(e=>!i.some(t=>t.matchId===e)).map(t=>({handler:e,matchId:t})),n={...t,workflow:[...i,...s]}
return`import setupDeprecationWorkflow from 'ember-cli-deprecation-workflow';\n\nsetupDeprecationWorkflow(${JSON.stringify(n,void 0,2)});`}function l(e,t,r,i){let s=o(e,t,r)
...
self.deprecationWorkflow.logCounts[e]=++i,i<=100&&(console.warn("DEPRECATION: "+t),100===i&&console.warn("To avoid console overflow, this deprecation will not be logged any more in this run."))
break}case"throw":throw new Error(t+` (id: ${r?.id||"unknown"})`)
default:i(t,r)}else{if(e&&e.throwOnUnhandled)throw new Error(t)
i(t,r)}}function c(e,t,r){self.deprecationWorkflow.deprecationLog.messages.add(t.id),r(e,t)}},8047(e,t,r){"use strict"
...
if(i&&i.has(a)){o++,n--
continue}return!0}o++}return!1}function H(e){return void 0!==e._instanceCache?e._instanceCache._storeWrapper:e}function W(e){return I.get(H(e))}var G=r(1505)
...
r&&t&&this.__graph.push({op:"updateRelationship",record:t,field:r.name,value:i})}return i}patch(e){Array.isArray(e)?((0,G.Yj)(this._capabilities),this._capabilities._store._join(()=>{for(const t of e)fe(this,t)})):fe(this,e)}mutate(e){this.__graph.update(e,!1)}peek(e){if((0,G.wT)(e)){const t=this.__safePeek(e,!1)
if(!t)return null
...
a&&Object.keys(a).forEach(t=>{a[t].definition.isImplicit||(o[t]=structuredClone(this.__graph.getData(e,t)))}),(0,G.Yj)(this._capabilities)
const l=this._capabilities._store
return pe(this,e).forEach((t,r)=>{if(r in n&&void 0!==n[r])return
const i=te(t,e,l)
void 0!==i&&(n[r]=i)}),{type:r,id:i,lid:s,attributes:n,relationships:o}}const t=this.peekRequest(e)
...
if(!this.__cache.has(e))return void W(t)?.unload(e)
const r=!this.isDeletionCommitted(e)
let i=!1
const s=this.__peek(e,!1)
s.isNew||s.isDeletionCommitted?W(t)?.push({op:"deleteRecord",record:e,isNew:s.isNew}):W(t)?.unload(e),s.localAttrs=null,s.remoteAttrs=null,s.defaultAttrs=null,s.inflightAttrs=null
...
return i=i?t.updateRecordIdentifier(i,r):t.getOrCreateRecordIdentifier(r),e.upsert(i,r,e._capabilities.hasRecord(i)),i}function ue(e,t){const r=W(e),i=r?.identifiers.get(t)
if(!i)return V
const s=[]
...
const n=e.__safePeek(t,!1),o=!!n,a=n||e._createCache(t),l=function(e,t,r){(0,G.Yj)(t)
...
r?(r.isDeleted=!0,r.isDeletionCommitted=!0,e.unloadRecord(t.record)):W(e._capabilities)?.push({op:"deleteRecord",record:t.record,isNew:!1})}else"field"in t&&function(e,t){const r=e.__documents.get(t.record.lid),{content:i}=r
if("data"===t.field){let r=!1
...
return this._snapshots=t.source.map(t=>e.createSnapshot(t)),this._snapshots}}function Se(e){}function Ae(e,t,r,i,s,n){return e?e.normalizeResponse(t,r,i,s,n):i}class Ee{constructor(e,t,r){this._store=r,this.__attributes=null,this._belongsToRelationships=Object.create(null),this._belongsToIds=Object.create(null),this._hasManyRelationships=Object.create(null),this._hasManyIds=Object.create(null),(0,G.Rh)(r)
...
let n
if((0,G.Rh)(t),t._instanceCache.recordIsLoaded(i))if(s.reload)n=t._fetchManager.scheduleFetch(i,s,e.request)
else{let r=null
...
case"findAll":return function(e){const{store:t,data:r}=e.request,{type:i,options:s}=r;(0,G.Rh)(t)
...
case"updateRecord":case"createRecord":case"deleteRecord":return function(e){const{store:t,data:r,op:i}=e.request,{options:s,record:n}=r;(0,G.Rh)(t),t.cache.willCommit(n,e)
...
const r=(0,G.di)(e),{_adapterCache:i}=this
let s=i[r]
if(s)return s
...
return i=s.lookup(`serializer:${t}`),void 0!==i?(r[t]=i,i):(i=r.application||s.lookup("serializer:application"),void 0!==i?(r[t]=i,r.application=i,i):null)}function Le(e,t){const r=(0,G.di)(e),i=this.serializerFor(r),s=this.modelFor(r)
return i.normalize(s,t)}function ze(e,t){const r=t||e,i=t?(0,G.di)(e):"application"
...
"function"==typeof t.destroy&&t.destroy()}}var Be=r(4471),Ke=r.n(Be),He=r(9370),We=r(941)
function Ge(e){{const t=(0,We.dasherize)(e)
...
if(Array.isArray(i.data)&&(a.data=n),"links"in i&&(a.links=i.links),"meta"in i&&(a.meta=i.meta),(0,G.Rh)(r),r._join(()=>{this.graph.push({op:"updateRelationship",record:o,field:this.key,value:a})}),!t)return this.load()}_isLoaded(){if(!this.hasManyRelationship.state.hasReceivedData)return!1
const e=this.graph.getData(this.hasManyRelationship.identifier,this.key)
return!!e.data&&e.data.every(e=>((0,G.Rh)(this.store),!0===this.store._instanceCache.recordIsLoaded(e,!0)))}value(){const e=kt.get(this.___identifier)
...
if((e.data||null===e.data)&&(n.data=i),"links"in e&&(n.links=e.links),"meta"in e&&(n.meta=e.meta),(0,G.Rh)(r),r._join(()=>{this.graph.push({op:"updateRelationship",record:s,field:this.key,value:n})}),!t)return this.load()}value(){const e=this._resource()
...
s.meta&&(e.meta=s.meta),s.links&&(e.links=s.links),t.length=0,(0,G.RX)(t,i)}mutate(e){this.cache.mutate(e)}_findBelongsTo(e,t,r,i){const s=Tt(this,e)
...
return this.cache.mutate({op:"replaceRelatedRecord",record:this.identifier,field:r,value:(i=t,i?(0,G.o)(i):null)},!0)
...
e=(0,G.WX)({store:this.store,manager:this,source:i,type:t.type,isLoaded:!t.isAsync,editable:!0,isAsync:t.isAsync,isPolymorphic:t.isPolymorphic,field:n,identifier:this.identifier,links:s.links||null,meta:s.meta||null}),this._manyArrayCache[r]=e}return e}}fetchAsyncHasMany(e,t,r,i){const s=Tt(this,e)
...
throw i&&!n&&(i.content&&i.content.isDestroying&&i.set("content",null),e.store.notifications._flush()),s}return n?i.isLoaded=!0:e.store.notifications._flush(),r.state.hasFailedLoadAttempt=!1,r.state.isStale=!1,n||!i?i:e.store.peekRecord(i)}function Mt(e,t){(0,G.Rh)(e)
...
function Ht(e){return!!e&&e instanceof Error&&"isAdapterError"in e&&!0===e.isAdapterError&&"code"in e&&"InvalidError"===e.code}class Wt{constructor(e){const t=(0,be.fV)(e,!1),r=(0,G.o)(e)
...
break
case"rejected":this.isSaving=!1,this._lastError=e,e.response&&Ht(e.response.data)||this._errorRequests.push(e),Gt(this)
break
case"fulfilled":this._errorRequests=[],this._lastError=null,this.isSaving=!1,this.notify("isDirty"),Gt(this)}else switch(e.state){case"pending":this.pendingCount++,this.notify("isLoading")
break
case"rejected":this.pendingCount--,this._lastError=e,e.response&&Ht(e.response.data)||this._errorRequests.push(e),this.notify("isLoading"),Gt(this)
break
case"fulfilled":this.pendingCount--,this.fulfilledCount++,this.notify("isLoading"),this.notify("isDirty"),Gt(this),this._errorRequests=[],this._lastError=null}}
...
return e?"rejected"===e.state&&e.response.data:null}get isPreloaded(){return!this.isEmpty&&this.isLoading}get stateName(){return this.isLoading?"root.loading":this.isEmpty?"root.empty":this.isDeleted?this.isSaving?"root.deleted.inFlight":this.isSaved?"root.deleted.saved":this.isValid?"root.deleted.uncommitted":"root.deleted.invalid":this.isNew?this.isSaving?"root.loaded.created.inFlight":this.isValid?"root.loaded.created.uncommitted":"root.loaded.created.invalid":this.isSaving?"root.loaded.updated.inFlight":this.isValid?this.isDirty?"root.loaded.updated.uncommitted":"root.loaded.saved":"root.loaded.updated.invalid"}get dirtyType(){return this.isLoading||this.isEmpty?"":this.isDirty&&this.isDeleted?"deleted":this.isNew?"created":this.isSaving||!this.isValid||this.isDirty?"updated":""}}function Gt(e){e.notify("isValid"),e.notify("isError"),e.notify("adapterError")}function Yt(e,t,r){const i=new WeakMap,s=r.get
return r.get=function(){let e=i.get(this)
return e||(e={hasComputed:!1,value:void 0},i.set(this,e)),e.hasComputed||(e.value=s.call(this),e.hasComputed=!0),e.value},r}tt((Nt=Wt).prototype,"isLoading",[ke.g]),tt(Nt.prototype,"isLoaded",[ke.g]),tt(Nt.prototype,"isSaved",[ke.g]),tt(Nt.prototype,"isEmpty",[ke.g]),tt(Nt.prototype,"isNew",[ke.g]),tt(Nt.prototype,"isDeleted",[ke.g]),tt(Nt.prototype,"isValid",[ke.g]),tt(Nt.prototype,"isDirty",[ke.g]),tt(Nt.prototype,"isError",[ke.g]),tt(Nt.prototype,"adapterError",[ke.g]),tt(Nt.prototype,"isPreloaded",[ke.m]),tt(Nt.prototype,"stateName",[ke.m]),tt(Nt.prototype,"dirtyType",[ke.m]),(0,ke.b)(Wt.prototype,"isSaving",!1)
...
const t=kt.get(e)
t&&(t.destroy(),kt.delete(e)),super.destroy()}get isEmpty(){return this.currentState.isEmpty}get isLoading(){return this.currentState.isLoading}get isLoaded(){return this.currentState.isLoaded}get hasDirtyAttributes(){return this.currentState.isDirty}get isSaving(){return this.currentState.isSaving}get isDeleted(){return this.currentState.isDeleted}get isNew(){return this.currentState.isNew}get isValid(){return this.currentState.isValid}get dirtyType(){return this.currentState.dirtyType}get isError(){return this.currentState.isError}set isError(e){}get id(){return(0,be.o)(this).id}set id(e){const t=(0,G.pG)(e),r=(0,be.o)(this),i=t!==r.id;(0,G.Rh)(this.store),null!==t&&i&&(this.store._instanceCache.setRecordId(r,t),this.store.notifications.notify(r,"identity",null))}toString(){return`<model::${this.constructor.modelName}:${this.id}>`}get currentState(){return this.___recordState||(this.___recordState=new Wt(this)),this.___recordState}set currentState(e){throw new Error("cannot set currentState")}get errors(){const e=jt.create({__record:this})
...
return this._schemas.set(e,o),o}fields(e){const t=Ge(e.type)
return this._schemas.has(t)||this._loadModelSchema(t),this._schemas.get(t).fields}hasResource(e){const t=Ge(e.type)
...
function u(e,t){return e.toString=()=>t?.name||e.name,(0,s.setModifierManager)(()=>c,e)}},81(e,t,r){"use strict"
...
return Object.keys(i).forEach(function(e){n[e]=i[e]}),n.enumerable=!!n.enumerable,n.configurable=!!n.configurable,("value"in n||n.initializer)&&(n.writable=!0),n=r.slice().reverse().reduce(function(r,i){return i(e,t,r)||r},n),s&&void 0!==n.initializer&&(n.value=n.initializer?n.initializer.call(s):void 0,n.initializer=void 0),void 0===n.initializer&&(Object.defineProperty(e,t,n),n=null),n}r.d(t,{_:()=>n,a:()=>s,b:()=>i})},5266(e,t,r){"use strict"
...
return this.tokens.push(r),this.tokens.scheduleTitleUpdate(),""}willDestroy(){super.willDestroy(),this.tokens.remove(this.tokenId),this.tokens.scheduleTitleUpdate()}},n=(0,o._)(s.prototype,"tokens",[i],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),s)},3299(e,t,r){"use strict"
...
i.appendChild(s),t.appendChild(i)}titleDidUpdate(e){}},o=(0,l._)(n.prototype,"router",[i],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),a=(0,l._)(n.prototype,"document",[s],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),n)},8411(e,t,r){"use strict"
...
return t&&t.default&&(t=t.default),t}}function _(e,t){if(!t)throw new Error(e)}y(m,"moduleBasedResolver",!0)},8604(e){var t
...
var o=r[n.index]
a(l(i(e,o.loc.start.offset,o.loc.end.offset),t.source,o.loc.start.line,o.loc.start.column),e,t.source,o.loc.start.line,o.loc.start.column)}},e.exports=t()},2139(e,t,r){"use strict"
...
!function(e,t,r){for(let s of r)e.initializer(i(t,s))}(e,l,o),function(e,t,r){for(let s of r)e.instanceInitializer(i(t,s))}(e,l,a)}r.r(t),r.d(t,{default:()=>s})}}])
